...
const leloi = {
  info: [
    {
      key: "logo-header",
      displayPrefix: "",
      value: staticUrl + "/static/upload/hospitals/leloi/header_logo.png"
    },
    {
      key: "logo-footer",
      displayPrefix: "",
      value: staticUrl + "/static/upload/hospitals/leloi/footer_logo.png"
    },
    {
      key: "logo-header-white",
      displayPrefix: "",
      value: staticUrl + "/static/upload/hospitals/leloi/logo_header_white.png"
    },
    {
      key: "name",
      displayPrefix: "",
      value: "Bệnh viện Lê Lợi"
    },
    {
      key: "address",
      displayPrefix: "Địa chỉ:",
      value:
        "Số 22 Lê Lợi, Phường 1, Thành phố Vũng Tàu, Tỉnh Bà Rịa - Vũng Tàu"
    },
    {
      key: "website",
      displayPrefix: "Website:",
      value: "http://benhvienleloi.com.vn/"
    },
    {
      key: "email",
      displayPrefix: "Email:",
      value: "bvleloihospital@gmail.com"
    },
    {
      key: "phone",
      displayPrefix: "Điện thoại:",
      value: "(0254) 3832667 - (0254) 3839233"
    },
    {
      key: "ios",
      displayPrefix: "",
    ...
    },
    {
      ...
      displayPrefix: "",
      value:
        "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3924.8601427985373!2d107.07267581533716!3d10.353065969694715!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31756f94fa22f26f%3A0xafdc104233c94ef0!2zQuG7h25oIHZp4buHbiBMw6ogTOG7o2k!5e0!3m2!1svi!2s!4v1591416627992!5m2!1svi!2s"
    },
    {
      key: "login",
      link: "/dang-nhap",
    ...
    },
    {
      key: "working-time",
      displayPrefix: "Thời gian làm việc",
      value: "07:00 đến 17:00"
    },
    {
      key: "bien-lai",
      displayPrefix: "",
      value: staticUrl + "/static/upload/hospitals/leloi/bien_lai.png"
    }
  ],
  banners: [
    {
      ...
      list: [
        {
          key: 1,
          url: staticUrl + "/static/upload/hospitals/leloi/banner_desktop.png",
    ...
    },
    {
      ...
      list: [
        {
          key: 2,
          url: staticUrl + "/static/upload/hospitals/leloi/banner_mobile.png",
          style: "center bottom no-repeat"
        }
      ]
    },
    {
      ...
      list: [
        {
          key: 1,
          url: staticUrl + "/static/upload/hospitals/leloi/slide.png",
          style: ""
        }
      ]
    }
  ...
  menu: [
    ...
    },
    {
      ...
      <li>
        ...
        <div class="timeline_content">
          ...
          <div class="ct_inside">
            <ul>
              <li>
                Người dùng truy cập và đăng nhập phần mềm qua:
              </li>
              <li>
               Ứng dụng di động: "Bệnh viện Lê Lợi" hoặc website: "https://leloi.medpro.com.vn"
              </li>
              <li>
                Chọn thông tin khám: Chuyên khoa, dịch vụ, ngày khám, giờ khám và có BHYT hay không.
              </li>
            </ul>
          </div>
        </div>
      ...
      <li>
        ...
        <div class="timeline_content">
          ...
          <div class="ct_inside">
            ...
            <p>
              <strong>
               Lưu ý tổng số tiền thanh toán sẽ bao gồm:
              </strong>
            </p>
            <ul>
              <li>
              ...
              <li>
                Sau khi thanh toán thành công Phiếu khám điện tử
                sẽ được gửi qua email, tin nhắn sms và trên phần
                mềm.
              </li>
            </ul>
          </div>
      ...
      <li>
        ...
        <div class="timeline_content">
          ...
          <div class="ct_inside">
            <ul>
              <li>
              <strong>Đối với Người bệnh có thẻ BHYT:</strong> Vui lòng mang thẻ BHYT và giấy tờ tuỳ thân, và đến quầy tiếp nhận số 2 trước giờ hẹn 15 phút để được hướng dẫn vào phòng khám.
              </li>
              <li>
              <strong>Đối với Người bệnh KHÔNG có thẻ BHYT:</strong>
                  Bệnh nhân vui lòng đến quầy tiếp nhận số 2 trước giờ hẹn 15 phút để được hướng dẫn vào phòng khám.
              </li>
            </ul>
          </div>
        </div>
      ...
      <li>
        <p class="timeline_date">&nbsp;</p>
        <div class="timeline_content">
          <h3>Ghi chú khi tái khám:</h3>
          <div class="ct_inside">
            <ul>
              <li>

Sau khi Người bệnh khám xong, Người bệnh sử dụng phần mềm để đặt khám cho lần hẹn tái khám kế tiếp (nếu có) như BƯỚC 1 và BƯỚC 2 để nhận phiếu khám điện tử .
              </li>
  ...
  menuFooter: [
    ...
    },
    {
      ...
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p><strong>THỜI GIAN ĐĂNG K&Yacute;</strong></p>
      <ul>
      <li>Thời gian&nbsp;đăng k&yacute; trước ng&agrave;y kh&aacute;m đến 30&nbsp;ng&agrave;y.</li>
      <li>Nếu muốn chọn&nbsp;kh&aacute;m v&agrave;o ng&agrave;y h&ocirc;m sau,&nbsp;Bạn phải thực hiện việc đăng k&yacute; v&agrave; ho&agrave;n tất thanh to&aacute;n&nbsp;trước 16h của ng&agrave;y h&ocirc;m nay, sau 16h Bạn kh&ocirc;ng thể đăng k&yacute; kh&aacute;m v&agrave;o ng&agrave;y h&ocirc;m sau được nữa.</li>
      </ul>
      <p>&nbsp;</p>
      <p><strong>&nbsp;</strong></p>
      <p><strong>TIỀN V&Agrave; PH&Iacute; ĐĂNG K&Yacute; KH&Aacute;M</strong></p>
      <p>Khi đăng k&yacute; kh&aacute;m tr&ecirc;n Phần mềm, bạn sẽ&nbsp;trả c&aacute;c khoản tiền v&agrave; ph&iacute;&nbsp;bao gồm:</p>
      <ul>
      <li>Tiền kh&aacute;m bệnh: l&agrave; tiền bạn trả cho việc sử dụng&nbsp;dịch vụ kh&aacute;m chữa bệnh của bệnh viện. Gi&aacute; kh&aacute;m bệnh&nbsp;sẽ thay đổi t&ugrave;y theo chuy&ecirc;n khoa v&agrave;&nbsp;do bệnh viện quy định.</li>
      <li>Ph&iacute; tiện &iacute;ch: l&agrave; tiền&nbsp;hỗ trợ cho việc&nbsp;sử dụng dịch vụ đăng k&yacute; kh&aacute;m bệnh trực tuyến (đ&atilde; bao gồm&nbsp;ph&iacute; c&aacute;c&nbsp;tin nhắn, email...). Bạn vui l&ograve;ng kiểm tra Tổng tiền thanh to&aacute;n trước khi thực hiện việc thanh to&aacute;n.</li>
      </ul>
      <p>Khi bạn thực hiện việc&nbsp;thanh to&aacute;n, đồng nghĩa với với việc bạn ho&agrave;n to&agrave;n&nbsp;đồng &yacute;, tự nguyện&nbsp;v&agrave; kh&ocirc;ng c&oacute; bất kỳ khiếu nại hoặc khiếu kiện n&agrave;o về bất kỳ một khoản tiền hoặc ph&iacute; n&agrave;o trong qu&aacute; tr&igrave;nh sử dụng phần mềm&nbsp;về sau.</p>
      <p>&nbsp;</p>
      <p><strong>PHƯƠNG THỨC THANH TO&Aacute;N</strong></p>
      <ul>
      <li>Bạn c&oacute; thể thanh to&aacute;n c&aacute;c khoản tiền v&agrave; ph&iacute; (nếu c&oacute;) trong qu&aacute;&nbsp;tr&igrave;nh sử&nbsp;dụng phần mềm bằng&nbsp;h&igrave;nh thức thanh to&aacute;n trực tuyến th&ocirc;ng qua:</li>
      <ul>
      ...
      <li>C&aacute;c v&iacute; điện tử đ&atilde; t&iacute;ch hợp tr&ecirc;n phần mềm</li>
      </ul>
      ...
      <p>&nbsp;</p>
      <p><strong>C&Aacute;CH THỨC NHẬN PHIẾU KH&Aacute;M BỆNH</strong></p>
      <ul>
      <li>Sau khi đăng k&yacute; v&agrave; thanh to&aacute;n th&agrave;nh c&ocirc;ng, Bạn sẽ nhận được Phiếu Kh&aacute;m Bệnh Điện Tử qua ba h&igrave;nh thức:</li>
      <ul>
      <li>Tr&ecirc;n Phần mềm: Bạn&nbsp;c&oacute; thể v&agrave;o mục Th&ocirc;ng Tin T&agrave;i Khoản &gt; Phiếu kh&aacute;m bệnh &gt; v&agrave; t&igrave;m thấy phiếu kh&aacute;m bệnh được gửi đến t&agrave;i khoản của bạn tr&ecirc;n Phần mềm.&nbsp;</li>
      <li>Qua email: Nếu trong hồ sơ bệnh nh&acirc;n bạn c&oacute; cung cấp địa chỉ email,&nbsp;phiếu kh&aacute;m bệnh cũng&nbsp;sẽ được&nbsp;gửi ngay đến địa chỉ email của bạn, bạn c&oacute; thể kiểm tra hộp thư đến hoặc Spam để nhận phiếu kh&aacute;m bệnh.</li>
      <li>Tin nhắn&nbsp;sms: Bạn cũng c&oacute; thể y&ecirc;u cầu nhận th&ocirc;ng tin phiếu kh&aacute;m bệnh qua tin nhắn sms, bằng c&aacute;ch:&nbsp;chọn "Gửi tin nhắn sms" &gt; nhập số điện thoại muốn nhận tin &gt; bấm&nbsp;"X&aacute;c nhận". Phần mềm&nbsp;gửi th&ocirc;ng tin phiếu kh&aacute;m bệnh đến số điện thoại bạn vừa nhập&nbsp;qua&nbsp;tin nhắn sms.</li>
      </ul>
      </ul>
      <p>Mỗi phiếu kh&aacute;m bệnh bạn c&oacute; thể&nbsp;y&ecirc;u cầu gửi tin nhắn sms&nbsp;hai&nbsp;lần, v&agrave; ho&agrave;n to&agrave;n miễn ph&iacute;.</p>
      <ul>
      <li>Khi đ&ecirc;́n ngày khám:</li>
      <ul>
      <li>Người b&ecirc;̣nh kh&ocirc;ng BHYT sẽ đ&ecirc;́n cửa tiếp nhận số 1, trước giờ hẹn&nbsp;15 - 30 phút đ&ecirc;̉ khám b&ecirc;̣nh..</li>
      </ul>
      </ul>
      <p>&nbsp;</p>
      <p><strong>GI&Aacute; TRỊ SỬ DỤNG PHIẾU KH&Aacute;M BỆNH</strong></p>
      <ul>
      <li>Phiếu kh&aacute;m bệnh giấy&nbsp;c&oacute; gi&aacute; trị sử dụng từ 6h30 đến 16h của ng&agrave;y kh&aacute;m in tr&ecirc;n phiếu.&nbsp;Phiếu kh&aacute;m bệnh giấy sử dụng&nbsp;để v&agrave;o ph&ograve;ng kh&aacute;m.</li>
      <li>Phiếu kh&aacute;m bệnh điện tử c&oacute; gi&aacute; trị sử dụng đến 16h &nbsp;trong ng&agrave;y kh&aacute;m.&nbsp;Phiếu kh&aacute;m bệnh điện tử d&ugrave;ng để in/nhận phiếu kh&aacute;m bệnh giấy, hoặc d&ugrave;ng để hủy phiếu kh&aacute;m tr&ecirc;n phần mềm v&agrave; nhận lại gi&aacute; kh&aacute;m bệnh&nbsp;đ&atilde; thanh to&aacute;n.</li>
      </ul>
      <p>&nbsp;</p>
      <p><strong>THAY ĐỔI TH&Ocirc;NG TIN BỆNH NH&Acirc;N TR&Ecirc;N PHIẾU KH&Aacute;M BỆNH</strong></p>
      <ul>
      <li>Sau khi đăng k&yacute; kh&aacute;m bệnh th&agrave;nh c&ocirc;ng,&nbsp;th&ocirc;ng tin bệnh nh&acirc;n&nbsp;tr&ecirc;n phiếu kh&aacute;m bệnh sẽ&nbsp;kh&ocirc;ng&nbsp;thể thay đổi.</li>
      <li>Nếu c&oacute; sự sai lệch về th&ocirc;ng tin bệnh nh&acirc;n, bạn vui l&ograve;ng&nbsp;hủy&nbsp;phiếu kh&aacute;m bệnh đ&atilde; nhận v&agrave; thực hiện lượt&nbsp;đăng k&yacute; kh&aacute;m bệnh mới&nbsp;với c&aacute;c th&ocirc;ng tin ch&iacute;nh x&aacute;c hơn.</li>
      </ul>
      <p>&nbsp;</p>
      <p><strong>THAY ĐỔI TH&Ocirc;NG TIN KH&Aacute;M TR&Ecirc;N PHIẾU KH&Aacute;M BỆNH</strong></p>
      <ul>
      <li>Sau khi đăng k&yacute; kh&aacute;m bệnh th&agrave;nh c&ocirc;ng,&nbsp;th&ocirc;ng tin kh&aacute;m&nbsp;tr&ecirc;n phiếu kh&aacute;m bệnh sẽ&nbsp;kh&ocirc;ng&nbsp;thể thay đổi.</li>
      <li><u>Trừ trường hợp</u>: Lịch kh&aacute;m của b&aacute;c sĩ tr&ecirc;n phiếu kh&aacute;m bệnh thay đổi v&agrave;o ng&agrave;y kh&aacute;m đ&atilde; đăng k&yacute;. Khi đ&oacute;, việc&nbsp;chỉnh sửa Th&ocirc;ng Tin Kh&aacute;m được&nbsp;quy định như&nbsp;sau:</li>
      <ul>
      <li>Phải chỉnh sửa trước 16h của ng&agrave;y trước ng&agrave;y kh&aacute;m.&nbsp;</li>
      ...
      <p>&nbsp;</p>
      <p><strong>QUY ĐỊNH HO&Agrave;N TIỀN</strong></p>
      <ul>
      ...
      <li>Quy định chung của việc ho&agrave;n tiền:</li>
      <ul>
      <li>Bạn chỉ được ho&agrave;n lại tiền&nbsp;kh&aacute;m bệnh đ&atilde; thanh to&aacute;n, Ph&iacute; tiện &iacute;ch sẽ kh&ocirc;ng được ho&agrave;n lại.&nbsp;</li>
      <li>Kh&ocirc;ng c&oacute;&nbsp;bất kỳ một khoản ph&iacute; n&agrave;o được t&iacute;nh trong việc ho&agrave;n tiền.&nbsp;</li>
      <li>Thời gian bạn nhận được tiền ho&agrave;n t&ugrave;y theo quy định của ng&acirc;n h&agrave;ng ph&aacute;t h&agrave;nh thẻ của bạn, th&ocirc;ng thường:</li>
      <ul>
